...
import stylesCss from 'themes/dreierschach/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_dreierschach_componentCss']) {
    
    document['_vaadintheme_dreierschach_componentCss'] = true;
  }
